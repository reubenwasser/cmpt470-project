...
class Register extends React.Component {
  ...
  render() {
    ...
    return (
      <div
        className='flex justify-around flex-row mv6'
        onKeyDown={this.onKeyPressRegister}
      >
        <div className='dib br3 ma3 w-40'>
          <h1>Did you know?</h1>
          <p>
            <strong>Coronavirus disease (COVID-19)</strong> is an infectious
        ...
        <div className='br3 ba'>
          <div>
            <h1>Register Form</h1>
            <div>
              <label className='fw6 lh-copy f5 ma3' htmlFor='full-name'>
                Fullname:
              </label>
              <input
                className='ma3 w-70 input-reset'
                id='fn'
                type='text'
                name='fullname'
                size='50'
            ...
            <div>
              <label className='fw6 lh-copy f5 ma3' htmlFor='email-address'>
                Username:{' '}
              </label>
              <input
                className='ma3 w-70 input-reset'
            ...
            <div className='flex justify-around flex-row'>
              <label className='fw6 lh-copy f5 ma3' htmlFor='password'>
                Password:{' '}
              </label>
              <input
                className='ma3 w-70 input-reset'
            ...
            <div>
              <label className='fw6 lh-copy f5 ma3' htmlFor='dob'>
                Date of Birth:{' '}
              </label>
              <input
                className='ma3 w-60 input-reset'
                id='dob'
                type='date'
                name='dob'
                size='50'
            ...
            <div>
              <label className='fw6 lh-copy f5 ma3' htmlFor='city'>
                City:{' '}
              </label>
              <input
                className='ma3 w-70 input-reset'
