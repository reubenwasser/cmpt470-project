			...
			<div>
				...
				<div class="page_body">
			        ...
			        >
			          ...
			          <button onClick={this.SeePercent}>Check</button>
			   
			          <div onChange={this.handleChange}>
			          	<h3>Do you have a fever</h3>
						<input type="radio" id="fever_yes" name="fever" value="2"/>
						...
						<div onChange={this.handleChange}>
							...
							<input type="radio" id="cough_yes" name="cough" value="2"/>
						...
						<div onChange={this.handleChange}>
							...
							<input type="radio" id="tired_yes" name="tired" value="2"/>
						...
						<div onChange={this.handleChange}>
							...
							<input type="radio" id="aches_yes" name="aches" value="1"/>
							<label for="aches_yes">Yes</label>
							<input type="radio" id="aches_no" name="aches" value="0"/>
							<label for="aches_no">No</label><br/><br/>
						</div>
						<div onChange={this.handleChange}>
							<h3>Do you have conjunctivitis (pink_eye)</h3>
							<input type="radio" id="pink_eye_yes" name="pink_eye" value="1"/>
							<label for="pink_eye_yes">Yes</label>
							<input type="radio" id="pink_eye_no" name="pink_eye" value="0"/>
							<label for="pink_eye_no">No</label><br/><br/>
						</div>
						<div onChange={this.handleChange}>
							<h3>Do you have headache</h3>
							<input type="radio" id="headache_yes" name="headache" value="1"/>
							<label for="headache_yes">Yes</label>
							<input type="radio" id="headache_no" name="headache" value="0"/>
							<label for="headache_no">No</label><br/><br/>
						</div>
						<div onChange={this.handleChange}>
							<h3>Do you have loss of taste</h3>
							<input type="radio" id="no_taste_yes" name="no_taste" value="1"/>
							<label for="no_taste_yes">Yes</label>
							<input type="radio" id="no_taste_no" name="no_taste" value="0"/>
							<label for="no_taste_no">No</label><br/><br/>
						</div>
						<div onChange={this.handleChange}>
							<h3>Do you have loss of smell</h3>
							<input type="radio" id="no_smell_yes" name="no_smell" value="1"/>
							<label for="no_smell_yes">Yes</label>
							<input type="radio" id="no_smell_no" name="no_smell" value="0"/>
							<label for="no_smell_no">No</label><br/><br/>
						</div>
						<div onChange={this.handleChange}>
							<h3>Do you have a rash on skin, or discolouration of fingers or toes</h3>
							<input type="radio" id="rash_yes" name="rash" value="1"/>
							<label for="rash_yes">Yes</label>
							<input type="radio" id="no_smell_no" name="rash" value="0"/>
							<label for="rash_no">No</label><br/><br/>
						</div>
						<div onChange={this.handleChange}>
							<h3>Do you have a difficulty in breathing or shortness of breath</h3>
							<input type="radio" id="breathing_yes" name="breathing" value="3"/>
							<label for="breathing_yes">Yes</label>
							<input type="radio" id="breathing_no" name="breathing" value="0"/>
							<label for="breathing_no">No</label><br/><br/>
						</div>
						<div onChange={this.handleChange}>
							<h3>Do you have a chest pain or pressure</h3>
							<input type="radio" id="chest_pain_yes" name="chest_pain" value="3"/>
							<label for="chest_pain_yes">Yes</label>
							<input type="radio" id="breathing_no" name="chest_pain" value="0"/>
							<label for="chest_pain_no">No</label><br/><br/>
						</div>
						<div onChange={this.handleChange}>
							<h3>Do you have a loss of speech or movement</h3>
							<input type="radio" id="movement_yes" name="movement" value="3"/>
							<label for="movement_yes">Yes</label>
							<input type="radio" id="movement_no" name="movement" value="0"/>
						...
						<h2>The percentage of you having COVID-19 is {this.state.total}</h2>
